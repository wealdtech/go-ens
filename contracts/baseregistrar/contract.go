...
//
// Solidity: function reclaim(uint256 id) returns()
func (_Contract *ContractTransactor) Reclaim(opts *bind.TransactOpts, id *big.Int) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "reclaim", id)
}

// Reclaim is a paid mutator transaction binding the contract method 0x2dabbeed.
//
// Solidity: function reclaim(uint256 id) returns()
func (_Contract *ContractSession) Reclaim(id *big.Int) (*types.Transaction, error) {
	return _Contract.Contract.Reclaim(&_Contract.TransactOpts, id)
}

// Reclaim is a paid mutator transaction binding the contract method 0x2dabbeed.
//
// Solidity: function reclaim(uint256 id) returns()
func (_Contract *ContractTransactorSession) Reclaim(id *big.Int) (*types.Transaction, error) {
	return _Contract.Contract.Reclaim(&_Contract.TransactOpts, id)
}
