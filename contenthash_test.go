...
func TestContenthash(t *testing.T) {
	tests := []struct {
		...
		{ // 10
			repr: "/onion/",
			err:  errors.New("onion address should be 16 characters"),
		},
		{ // 11
			repr: "/onion/3g2upl4pq6kufc4m",
			bin:  []byte{0xbc, 0x03, 0x33, 0x67, 0x32, 0x75, 0x70, 0x6c, 0x34, 0x70, 0x71, 0x36, 0x6b, 0x75, 0x66, 0x63, 0x34, 0x6d},
		},
		{ // 12
			repr: "/onion3/",
			err:  errors.New("onion3 address should be 56 characters"),
		},
		{ // 13
			repr: "/onion3/4acth47i6kxnvkewtm6q7ib2s3ufpo5sqbsnzjpbi7utijcltosqemad",
			bin:  []byte{0xbd, 0x03, 0x34, 0x61, 0x63, 0x74, 0x68, 0x34, 0x37, 0x69, 0x36, 0x6b, 0x78, 0x6e, 0x76, 0x6b, 0x65, 0x77, 0x74, 0x6d, 0x36, 0x71, 0x37, 0x69, 0x62, 0x32, 0x73, 0x33, 0x75, 0x66, 0x70, 0x6f, 0x35, 0x73, 0x71, 0x62, 0x73, 0x6e, 0x7a, 0x6a, 0x70, 0x62, 0x69, 0x37, 0x75, 0x74, 0x69, 0x6a, 0x63, 0x6c, 0x74, 0x6f, 0x73, 0x71, 0x65, 0x6d, 0x61, 0x64},
		},
	}
	...
	for i, test := range tests {
		...
		if test.err != nil {
			assert.NotNil(t, err, fmt.Sprintf("missing error at test %d", i))
